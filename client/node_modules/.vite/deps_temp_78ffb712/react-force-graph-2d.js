...
function $() {
  for (var n2, u2, t5, r2, o2, f2, c5, s2 = 1; i.length; )
    i.length > s2 && i.sort(e), n2 = i.shift(), s2 = i.length, n2.__d && (t5 = void 0, o2 = (r2 = (u2 = n2).__v).__e, f2 = [], c5 = [], u2.__P && ((t5 = d({}, r2)).__v = r2.__v + 1, l.vnode && l.vnode(t5), O(u2.__P, t5, r2, u2.__n, u2.__P.namespaceURI, 32 & r2.__u ? [o2] : null, f2, null == o2 ? S(r2) : o2, !!(32 & r2.__u), c5), t5.__v = r2.__v, t5.__.__k[t5.__i] = t5, N(f2, t5, c5), t5.__e != o2 && C2(t5)));
  $.__r = 0;
}
function I(n2, l2, u2, t5, i2, r2, o2, e3, f2, c5, s2) {
  var a3, h2, y3, w2, d2, g2, _2 = t5 && t5.__k || v, m3 = l2.length;
  for (f2 = P(u2, l2, _2, f2, m3), a3 = 0; a3 < m3; a3++)
...
function A2(n2, l2, u2) {
  ...
  if ("function" == typeof n2.type) {
    for (t5 = n2.__k, i2 = 0; t5 && i2 < t5.length; i2++)
      t5[i2] && (t5[i2].__ = n2, l2 = A2(t5[i2], l2, u2));
    return l2;
  }
...
function L(n2, l2, u2, t5) {
  ...
  if (null === c5 && null == n2.key || s2 && e3 == c5.key && f2 == c5.type)
    return u2;
  if (t5 > (s2 ? 1 : 0)) {
...
function O(n2, u2, t5, i2, r2, o2, e3, f2, c5, s2) {
  ...
  n:
    if ("function" == typeof j2)
      try {
        if (b = u2.props, S2 = "prototype" in j2 && j2.prototype.render, C3 = (a3 = j2.contextType) && i2[a3.__c], M2 = a3 ? C3 ? C3.props.value : a3.__ : i2, t5.__c ? m3 = (h2 = u2.__c = t5.__c).__ = h2.__E : (S2 ? u2.__c = h2 = new j2(b, M2) : (u2.__c = h2 = new x(b, M2), h2.constructor = j2, h2.render = E2), C3 && C3.sub(h2), h2.props = b, h2.state || (h2.state = {}), h2.context = M2, h2.__n = i2, p2 = h2.__d = true, h2.__h = [], h2._sb = []), S2 && null == h2.__s && (h2.__s = h2.state), S2 && null != j2.getDerivedStateFromProps && (h2.__s == h2.state && (h2.__s = d({}, h2.__s)), d(h2.__s, j2.getDerivedStateFromProps(b, h2.__s))), v2 = h2.props, y3 = h2.state, h2.__v = u2, p2)
...
function q(u2, t5, i2, r2, o2, e3, f2, c5, s2) {
  ...
  if (null == x3)
    ...
    if (e3 = e3 && n.call(u2.childNodes), b = i2.props || p, !c5 && null != e3)
